...
public enum UserRole {
    ...
    PLANNER(Set.of(Permission.USER_MODIFY, Permission.USER_WRITE, Permission.USER_READ)),
    USER(Set.of(Permission.USER_MODIFY, Permission.USER_WRITE, Permission.USER_READ)),
